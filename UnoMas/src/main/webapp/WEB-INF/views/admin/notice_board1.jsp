    ...
    <form name="frmList" onsubmit="return chkFormList(this)">
        ...
        <table class="xans-board-listheader jh" style="width: 100%;">
            ...
            <c:forEach items="${noticeList }" var="vo">
                <tr>
                    <td width="50"  align="center" >${vo.notice_num }</td>
                    ...
                    <td width="100" align="center" class="eng2">${vo.notice_regdate }</td>
                    <td width="30" align="center" class="eng2">${vo.notice_readcnt }</td>
                </tr>
            </c:forEach>
