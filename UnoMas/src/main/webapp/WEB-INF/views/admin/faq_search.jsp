											...
											<ul class="pagination">
												<c:if test="${pagingVO.prev }">
													<li class="page-item"><a class="page-link text-dark"
														href='<c:url value="/admin/faq_search${pagingVO.makeQuery(pagingVO.startPage-1) }"/>'
												...
												<c:forEach begin="${pagingVO.startPage }"
													...
													<li class="page-item"><a class="page-link text-dark"
														href='<c:url value="/admin/faq_search${pagingVO.makeQuery(pageNum) }"/>'>${pageNum }</a></li>
												</c:forEach>
												<c:if test="${pagingVO.next }">
													<li class="page-item"><a class="page-link text-dark"
														href='<c:url value="/admin/faq_search${pagingVO.makeQuery(pagingVO.endPage+1) }"/>'
