        ...
        <div class="nav-item">
            <div class="container"> <!-- 카테고리 내외부 -->
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li><a href="/UnoMas/product/product_lookup"><span class="menu">상품관리</span></a></li>
                        <li><a href="/UnoMas/product/new_list"><span class="menu">신상품목</span></a></li>
                        <li><a href="/UnoMas/product/sale_list"><span class="menu">특가품목</span></a></li>
                        <li><a href="/UnoMas/admin/notice_board"><span class="menu">공지사항</span></a></li>
                        <li><a href="/UnoMas/admin/qna_board"><span class="menu">1:1문의 답변 현황</span></a></li>
                    </ul>
                </nav>
