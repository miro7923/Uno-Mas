...
<body>
    ...
    <div class="select">
    <select id="search_type_qni" name="search_type" class="search_select">
        ...
        <form name="frmList" id="form" method="get" action="?">
                ...
                <div class="xans-element- xans-myshop xans-myshop-couponserial ">
                    <table class="xans-board-listheader">
                        <tbody>
                            <tr>
                                <th class="input_txt_qni_num">번호</th>
                                <th class="input_txt_qni_cate">카테고리</th>
                                <th class="input_txt_qni_title">제목</th>
                                <th class="input_txt_qni_writer">작성자</th>
                            </tr>
                        </tbody>
                    </table> <!-- table header -->
                        ...
                        <div>
                            <table class="table_faq" onclick="view_content(this)" id="faq_7">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="70" align="center" class="input_txt_qni_num">${fn:length(pList)-i.index }</td>
                ...
                <li class="page-item">
                	<a class="page-link text-dark" href='<c:url value="/UnoMas/board/qni_search${pagingVO.makeQuery(pagingVO.firstPage) }"/>' >
                		<span>&lt;&lt;</span>
                	</a>
                </li>
                  <li class="page-item">
                    <a class="page-link text-dark" href='<c:url value="/UnoMas/board/qni_search${pagingVO.makeQuery(pagingVO.startPage-1) }"/>' aria-label="Previous">
                      <span aria-hidden="true">&lt;</span>
                    </a>
                  </li>
                  </c:if>
                  <c:forEach begin="${pagingVO.startPage }" end="${pagingVO.endPage }" var="pageNum">
                  <li class="page-item"><a class="page-link text-dark" href='<c:url value="/UnoMas/board/qni_search${pagingVO.makeQuery(pageNum) }"/>'>${pageNum }</a></li>
                  </c:forEach>
                  <c:if test="${pagingVO.next }">
                  <li class="page-item">
                    <a class="page-link text-dark" href='<c:url value="/UnoMas/board/qni_search${pagingVO.makeQuery(pagingVO.endPage+1) }"/>' aria-label="Next">
                      <span aria-hidden="true">&gt;</span>
                    </a>
                  </li>
                  <li class="page-item">
                	<a class="page-link text-dark" href='<c:url value="/UnoMas/board/qni_search${pagingVO.makeQuery(pagingVO.lastPage) }"/>' >
                		<span>&gt;&gt;</span>
                	</a>
                </li>
                  </c:if>
