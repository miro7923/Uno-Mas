						...
						<form role="form" method="post" class="checkout-form" id="register">
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="row">
										<div class="col-lg-12">
											<label>판매가<span>*</span></label> <input type="number" name="prod_price" id="prod_price">
										</div>
										<div class="col-lg-12">
											<label>할인율<span>*</span></label> <input type="number" name="prod_discntrate" id="prod_discntrate" placeholder="0 ~ 100">
										</div>
										<div class="col-lg-12">
											<label>상품 재고<span>*</span></label> <input type="number" name="prod_stock" class="prod_stock" id="prod_stock">
										</div>
										<div class="col-lg-12">
								...
								<div class="col-lg-6">
									<div class="place-order">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<label>유통기한<span>*</span></label><input type="number" name="prod_expire" id="selbox2" placeholder="남은 기한 ex) 7">
											</div>
<!-- 											<div class="col-lg-12"> -->
