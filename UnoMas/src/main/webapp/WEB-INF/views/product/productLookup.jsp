...
<!-- 																		<td class="cart-pic first-row"><input -->
...
<%-- 																			href="/product/status?prod_num=${vo.prod_num }&page=${pc.page}&perPageNum=${pc.perPageNum }"><span --%>
...
<!-- 																		<td class="cart-pic first-row"><input -->
<!-- 																			type="checkbox" class="chBox" name="chBox" -->
<%-- 																			prod_num="${vo.prod_num }"></td> --%>
<%-- 																		<td class="normal-row">${vo.prod_num }</td> --%>
<!-- 																																	<td class="cart-title first-row"> -->
<!-- 																		<td class="normal-row"><a -->
<%-- 																			href="/product/status?prod_num=${vo.prod_num }">${vo.prod_name }</a></td> --%>
...
<!--  																class="pagingBtn"  -->
<%--  																style="color: black; font-weight: bold;">${page }  --%>
<!--  															</a></span> -->
<%--  														</c:forEach> --%>
														...
														<c:choose>
															<c:when test="${vo.prod_stock eq 0 }">
																<td class="cart-pic first-row" style="text-align: center;">
																	<input type="checkbox" class="chBox" name="chBox" prod_num="${vo.prod_num }"></td>
																<td class="normal-row"><span class="sold">${vo.prod_num }</span></td>
																<td class="normal-row"><span class="sold">
																	<a href="/product/status?prod_num=${vo.prod_num }"><span class="sold">${vo.prod_name }</span></a></td>
																<td class="normal-row"><span class="sold">${vo.prod_price }</span></td>
																<td class="normal-row"><span class="sold">품절</span></td>
																<td class="normal-row"><span class="sold">${vo.prod_readcnt }</span></td>
																<td class="normal-row"><span class="sold">${vo.prod_sellcnt }</span></td>
															...
															<c:otherwise>
																...
																<td class="normal-row">${vo.prod_num }</td>
																<td class="normal-row">
																	<a href="/product/status?prod_num=${vo.prod_num }"><span class="normal">${vo.prod_name }</span></a></td>
																<td class="normal-row">${vo.prod_price }</td>
																<td class="normal-row">정상</td>
																<td class="normal-row">${vo.prod_readcnt }</td>
																<td class="normal-row">${vo.prod_sellcnt }</td>
